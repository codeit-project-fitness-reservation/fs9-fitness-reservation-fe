...
export default function FilterModal({
  ...
  return (
    ...
    >
      <div
        className="flex w-full max-w-[343px] flex-col gap-6 rounded-2xl bg-white p-6"
      ...
      >
        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <button className="flex w-full items-center justify-between rounded-lg border border-gray-300 bg-white px-3 py-2.5">
              <span className="text-base font-normal text-gray-500">
                {localFilters.time || '원하는 시간을 선택해주세요.'}
              </span>
              <svg
                width="17"
                height="17"
