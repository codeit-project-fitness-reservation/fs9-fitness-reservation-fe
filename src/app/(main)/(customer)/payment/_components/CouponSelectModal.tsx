          ...
          {availableCoupons.length === 0 ? (
            ...
            <div className="flex flex-col gap-3">
              ...
              {availableCoupons.map((coupon) => {
                ...
                const discountPoints = coupon.template?.discountPoints || 0;
                const discountPercentage = coupon.template?.discountPercentage || 0;
                const expiresAt = coupon.template?.expiresAt;
